...
class Settings(BaseSettings):
    ...
    #chatting limits
    STARTER_PLAN_EXTERNAL_BOT_MONTHLY_MESSAGES:int= 10
    FREE_PLAN_EXTERNAL_BOT_MONTHLY_MESSAGES:int= 10
    ENTERPRISE_PLAN_EXTERNAL_BOT_MONTHLY_MESSAGES:int= 10
    ENTERPRISE_PLAN_INTERNAL_BOT_MONTHLY_MESSAGES:int= 10


    STRIPE_ENTERPRISE_PRICE_ID_MONTHLY: str
    STRIPE_ENTERPRISE_PRICE_ID_YEARLY: str

    STRIPE_ENTERPRISE_USER_PRICE_ID_MONTHLY: str
    STRIPE_ENTERPRISE_USER_PRICE_ID_YEARLY: str
